...
public interface AlertRepository extends CrudRepository<Alert, Long> {
    ...
    @Query("SELECT new com.solidbeans.call4help.dtos.ReporterQuantityByAlert( a.id, a.alertDate, a.location, COUNT(a.reports)) FROM Alert a INNER JOIN a.reports r INNER JOIN a.users u WHERE u.userId =:userId GROUP BY a.id")
